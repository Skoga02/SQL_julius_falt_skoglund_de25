INSERT 
    ...
    description)
VALUES ('query',
    'request made to a database to retrive, modify or maintaine');
...
VALUES
    ...
    ('type hint', 'hint for witch type in parameters, return values in classes and function'),
    ('tuple', 'immutable, works similare to list, also store records')
    ;
