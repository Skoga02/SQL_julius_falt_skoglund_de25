...
<LineChart
    ...
    x = pay_date
    y = total_amount
    xAxisTitle="total_amount"
    yAxisTitle="payment_date"
    title="payment over time for store {inputs.store.vaule}"
/>